...
echo 1. Manually Updating from Git >> /var/www/html/log/gireset.log
cd /var/www/html
...
sudo chmod +x update.sh >> /var/www/html/log/gireset.log
sudo chmod +x wifion.sh >> /var/www/html/log/gireset.log
sudo chmod +x wifioff.sh >> /var/www/html/log/gireset.log
